...
import StartupUpdateCard from '../../../src/StartupPage/StartupUpdateCard';

export default {
  title: 'Antler Theme/Components/Startup Page/Update Card',
  argTypes: {
    teamName: {
      defaultValue: 'Antler',
      control: { type: 'text' },
...
export const UpdateCard = args => (
  <CardGrid>
    <StartupUpdateCard
      ...
      actionRows={[{ primaryButton: { label: 'Read More' } }]}
    />
  </CardGrid>
);
